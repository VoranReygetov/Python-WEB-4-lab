...
def book_list(request):
    ...
    if request.method == 'GET':
        ...
        for book in data['books']:
            ...
            # Create the new book entry with desired fields
            book_entry = {
                "id": book["id"],
        ...
        # Create a context dictionary with all the key-value pairs
        context = {
        ...
        # Use the context dictionary in the render function
